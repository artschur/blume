...
const caseStudies = [
  {
    ...
    description:
      'Criação do mais novo empreendimento do grupo costão. Incluí landing page, e um blog internacionalizado de facil uso do time de marketing.',
            ...
            >
              ...
              <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-xs flex flex-row gap-2 text-neutral-500 ml-2 whitespace-nowrap">
                    <ClockFading className="h-4 w-4" /> {study.completionTime}
                  </span>
                </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div>
              ...
              <p className="text-sm text-neutral-400">
                Nossos sites são construídos com foco em velocidade e desempenho, garantindo tempos
                de carregamento rápidos e uma experiência fluida para seus usuários.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-neutral-400">
                Implementamos as melhores práticas de SEO para garantir que seu site seja facilmente
                encontrado pelos motores de busca e alcance seu público-alvo.
              </p>
            </div>
          </motion.div>
        </div>
